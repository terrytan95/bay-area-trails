...
function A(){
  let isMobile = b <= 768;
  if (isMobile) {
    let center = new J(200, 0, 150);
    E({ target: center, zoom: 0.38, azimuth: Nu, polar: Mu });
  } else {
